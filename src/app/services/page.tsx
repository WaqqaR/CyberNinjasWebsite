  ...
  return (
    <div className="theme-bg-primary transition-colors duration-[1000ms]">
      ...
      <PageHero
        ...
        description="We specialize in Microsoft technologies and AI automation. Each engagement is crafted with care, ensuring solutions that truly transform your business."
      />
