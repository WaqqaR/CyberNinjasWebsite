...
export const metadata: Metadata = {
  title: "Power Platform Consultant Bootcamp | Cyber Ninjas Dojo",
  description:
    "A premium, cohort-based track that trains career switchers and IT professionals to operate as billable Power Platform consultants. Includes PL-200 preparation, Azure DevOps, Agile delivery, and full consultancy simulation. UK-based.",
  keywords: [
...
export default function PowerPlatformTrackPage() {
  return (
    <div className="theme-bg-primary dojo-page">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <p className="text-sm font-medium tracking-[0.3em] theme-text-subtle dark:text-red-500/80 uppercase mb-4">
                Dojo Track — Power Platform
              </p>
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-light theme-text-primary leading-tight mb-3">
                Power Platform{" "}
                <GlitchWord text="Consultant" className="font-semibold theme-text-secondary dark:text-red-500" />
              </h1>
              ...
              <p className="text-lg theme-text-muted leading-relaxed mb-10">
                Most Power Platform training stops at the tool. This track goes further. Over 8 to 12
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-16">
                ...
                <a
                  href="/dojo/power-platform/programme"
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <p className="text-stone-400 leading-relaxed border-l-2 border-red-500/30 pl-4 italic mt-8">
                This track is designed to close this gap before you start.
              </p>
            </div>
            <div>
      ...
      {/* ─── Scholarship ──────────────────────────────────────────────────── */}
      <ScholarshipSection track="power-platform" />
